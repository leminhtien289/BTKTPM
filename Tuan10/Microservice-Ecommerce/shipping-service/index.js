...
app.get('/shipments', (req, res) => res.json(db.prepare('SELECT * FROM shipments ORDER BY created_at DESC').all()));
...
app.post('/shipments', (req, res) => {
  ...
  log('info', 'Shipment created', { shipmentId: shipment.id, order_id });
...
app.patch('/shipments/:id/status', (req, res) => {
  ...
  log('info', 'Shipment status updated', { shipmentId: req.params.id, status });
...
app.listen(PORT, () => log('info', 'Shipping Service started', { port: PORT }));
